...
export class TableComponent implements OnInit {
  ...
  tableData: {date: Date, software: string, shop: string, value: number}[] = [
    ...
    { date: new Date(2022, 8, 2), software: 'Easy PosLite', shop: 'Woolworths', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2022, 9, 1), software: 'Easy PosLite', shop: 'TK Maxx', value: Math.floor(Math.random() * 100000) },
