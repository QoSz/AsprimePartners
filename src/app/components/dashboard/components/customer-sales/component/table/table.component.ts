...
export class TableComponent implements OnInit {
  ...
  tableData: {date: Date, software: string, shop: string, value: number}[] = [
    ...
    { date: new Date(2022, 2, 1), software: 'POSitive Accounting', shop: 'Naivas', value: 29500 },
    { date: new Date(2021, 5, 20), software: 'Easy PosLite', shop: 'Chandarana', value: 31000 },
    { date: new Date(2021, 10, 31), software: 'POSitive BackOffice', shop: 'Carrefour', value: (255 * 123) },
    ...
    { date: new Date(2022, 8, 2), software: 'POSitive Accounting', shop: 'Game', value: (1000 * 123) },
    ...
    { date: new Date(2022, 11, 9), software: 'POSitive HR', shop: 'Walmart', value: Math.floor(Math.random() * 100000) },
    ...
    { date: new Date(2022, 2, 1), software: 'POSitive Accounting', shop: 'Tesco', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2021, 5, 20), software: 'Easy PosLite', shop: 'M&S', value: Math.floor(Math.random() * 100000) },    
    { date: new Date(2021, 10, 31), software: 'Easy PosLite', shop: 'Spar', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2021, 12, 25), software: 'Easy PosLite', shop: 'Jumia', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2022, 7, 15), software: 'Easy PosLite', shop: 'Konga', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2022, 8, 2), software: 'POSitive BackOffice', shop: 'Woolworths', value: Math.floor(Math.random() * 100000) },
    { date: new Date(2022, 9, 1), software: 'POSitive HR', shop: 'TK Maxx', value: Math.floor(Math.random() * 100000) },
  ];
